...
// SBTI问题数据类
data class SbtiQuestion(
    val id: Int,
    val dimension: SbtiDimension,
    val question: String,
    val options: List<String>,
    val weights: List<Int>,
    val isGateQuestion: Boolean = false,
    val gateTriggerValue: Int? = null
)
...
// 获取SBTI筛选门问题
fun getSbtiGateQuestions(): List<SbtiQuestion> = listOf(
    SbtiQuestion(
        id = -2,
        dimension = SbtiDimension.S1,
        question = "您平时有什么爱好？",
        options = listOf("吃喝拉撒", "艺术爱好", "饮酒", "健身"),
        weights = listOf(1, 2, 3, 4),
        isGateQuestion = true,
        gateTriggerValue = 3
    ),
    SbtiQuestion(
        ...
        dimension = SbtiDimension.S1,
        question = "您对饮酒的态度是？",
        options = listOf("小酌怡情，喝不了太多。", "我习惯将白酒灌在保温杯，当白开水喝，酒精令我信服。"),
        weights = listOf(1, 2),
        isGateQuestion = true,
        gateTriggerValue = 2
    )
...
// 获取SBTI正式测试问题（30道）
fun getSbtiQuestions(): List<SbtiQuestion> = listOf(
    // Q1 - S1 自尊自信
    SbtiQuestion(
        id = 1,
        dimension = SbtiDimension.S1,
        question = "我不仅是屌丝，我还是joker,我还是咸鱼，这辈子没谈过一场恋爱，胆怯又自卑，我的青春就是一场又一场的意淫，每一天幻想着我也能有一个女孩子和我一起压马路，一起逛街，一起玩，现实却是爆了父母金币，读了个烂学校，混日子之后找班上，没有理想，没有目标，没有能力的三无人员，每次看到你能在网上开屌丝的玩笑，我都想哭，我就是地底下的老鼠，透过下水井的缝隙，窥探地上的各种美好，每一次看到这种都是对我心灵的一次伤害，对我生存空间的一次压缩，求求哥们给我们这种小丑一点活路吧，我真的不想在白天把枕巾哭湿一大片",
        options = listOf("我哭了。。", "这是什么。。", "这不是我！"),
    ...
    SbtiQuestion(
        ...
        options = listOf("确实", "有时", "不是"),
        weights = listOf(1, 2, 3)
    ),
    // Q3 - S2 自我清晰度
    SbtiQuestion(
        id = 3,
        dimension = SbtiDimension.S2,
        question = "我很清楚真正的自己是什么样的",
        options = listOf("不认同", "中立", "认同"),
        weights = listOf(1, 2, 3)
    ),
    // Q4 - S2
    SbtiQuestion(
    ...
    SbtiQuestion(
        id = 7,
        dimension = SbtiDimension.E1,
        question = "对象超过5小时没回消息，说自己窜稀了，你会怎么想？",
        options = listOf("拉稀不可能5小时，也许ta隐瞒了我。", "在信任和怀疑之间摇摆。", "也许今天ta真的不太舒服。"),
        weights = listOf(1, 2, 3)
    ),
    // Q8 - E1
    SbtiQuestion(
        ...
        options = listOf("是的", "偶尔", "不是"),
        weights = listOf(1, 2, 3)
    ),
    // Q9 - E2 情感投入度
    SbtiQuestion(
        id = 9,
        dimension = SbtiDimension.E2,
        question = "我对天发誓，我对待每一份感情都是认真的！",
        options = listOf("并没有", "也许？", "是的！（问心无愧骄傲脸）"),
        weights = listOf(1, 2, 3)
    ),
    // Q10 - E2
    SbtiQuestion(
        ...
        options = listOf("就算ta再优秀我也不会陷入太深。", "会介于A和C之间。", "会非常珍惜ta，也许会变成恋爱脑。"),
        weights = listOf(1, 2, 3)
    ),
    // Q11 - E3 边界与依赖
    SbtiQuestion(
        id = 11,
        dimension = SbtiDimension.E3,
        question = "恋爱后，对象非常黏人，你作何感想？",
        options = listOf("那很爽了", "都行无所谓", "我更喜欢保留独立空间"),
        weights = listOf(1, 2, 3)
    ),
    // Q12 - E3
    SbtiQuestion(
        ...
        options = listOf("我更喜欢依赖与被依赖", "看情况", "是的！（斩钉截铁地说道）"),
        weights = listOf(1, 2, 3)
    ),
    // Q13 - A1 世界观倾向
    SbtiQuestion(
        id = 13,
        dimension = SbtiDimension.A1,
        question = "大多数人是善良的",
        options = listOf("其实邪恶的人心比世界上的痔疮更多。", "也许吧。", "是的，我愿相信好人更多。"),
        weights = listOf(1, 2, 3)
    ),
    // Q14 - A1
    SbtiQuestion(
        ...
        options = listOf("呜呜她真好真可爱！居然给我棒棒糖！", "一脸懵逼，作挠头状", "这也许是一种新型诈骗？还是走开为好。"),
        weights = listOf(3, 2, 1)
    ),
    // Q15 - A2 规则与灵活度
    SbtiQuestion(
        id = 15,
        dimension = SbtiDimension.A2,
        question = "快考试了，学校规定必须上晚自习，请假会扣分，但今晚你约了女/男神一起玩《绝地求生：刺激战场》（一款刺激的游戏），你怎么办？",
        options = listOf("翘了！反正就一次！", "干脆请个假吧。", "都快考试了还去啥。"),
        weights = listOf(1, 2, 3)
    ),
    // Q16 - A2
    SbtiQuestion(
        ...
        options = listOf("认同", "保持中立", "不认同"),
        weights = listOf(1, 2, 3)
    ),
    // Q17 - A3 人生意义感
    SbtiQuestion(
        id = 17,
        dimension = SbtiDimension.A3,
        question = "我做事通常有目标。",
        options = listOf("不认同", "中立", "认同"),
        weights = listOf(1, 2, 3)
    ),
    ...
    SbtiQuestion(
        id = 18,
        dimension = SbtiDimension.A3,
        question = "突然某一天，我意识到人生哪有什么他妈的狗屁意义，人不过是和动物一样被各种欲望支配着，纯纯是被激素控制的东西，饿了就吃，困了就睡，一发情就想交配，我们简直和猪狗一样没什么区别。",
        options = listOf("是这样的。", "也许是，也许不是。", "这简直是胡扯"),
        weights = listOf(1, 2, 3)
    ),
    // Q19 - Ac1 动机导向
    SbtiQuestion(
        id = 19,
        dimension = SbtiDimension.Ac1,
    ...
    SbtiQuestion(
        ...
        options = listOf("再坐三十分钟看看，说不定就有了。", "用力拍打自己的屁股并说：\"死屁股，快拉啊！\"", "使用开塞露，快点拉出来才好。"),
        weights = listOf(1, 2, 3)
    ),
    // Q21 - Ac2 决策风格
    SbtiQuestion(
        id = 21,
        dimension = SbtiDimension.Ac2,
    ...
    SbtiQuestion(
        ...
        dimension = SbtiDimension.Ac2,
        question = "此题没有题目，请盲选",
        options = listOf("反复思考后感觉应该选A？", "啊，要不选B？", "不会就选C？"),
        weights = listOf(1, 2, 3)
    ),
    // Q23 - Ac3 执行模式
    SbtiQuestion(
        id = 23,
        dimension = SbtiDimension.Ac3,
        question = "别人说你\"执行力强\"，你内心更接近哪句？",
        options = listOf("我被逼到最后确实执行力超强。。。", "啊，有时候吧。", "是的，事情本来就该被推进"),
        weights = listOf(1, 2, 3)
    ),
    // Q24 - Ac3
    SbtiQuestion(
        ...
        options = listOf("然而计划不如变化快。", "有时能完成，有时不能。", "我讨厌被打破计划。"),
        weights = listOf(1, 2, 3)
    ),
    // Q25 - So1 社交主动性
    SbtiQuestion(
        id = 25,
        dimension = SbtiDimension.So1,
        question = "你因玩《第五人格》（一款刺激的游戏）而结识许多网友，并被邀请线下见面，你的想法是？",
        options = listOf("网上口嗨下就算了，真见面还是有点忐忑。", "见网友也挺好，反正谁来聊我就聊两句。", "我会打扮一番并热情聊天，万一呢，我是说万一呢？"),
        weights = listOf(1, 2, 3)
    ),
    // Q26 - So1
    SbtiQuestion(
        ...
        options = listOf("对\"朋友的朋友\"天然有点距离感，怕影响二人关系", "看对方，能玩就玩。", "朋友的朋友应该也算我的朋友！要热情聊天"),
        weights = listOf(1, 2, 3)
    ),
    // Q27 - So2 人际边界感
    SbtiQuestion(
        id = 27,
        dimension = SbtiDimension.So2,
        question = "我和人相处主打一个电子围栏，靠太近会自动报警。",
        options = listOf("认同", "中立", "不认同"),
        weights = listOf(3, 2, 1)
    ),
    // Q28 - So2
    SbtiQuestion(
    ...
    SbtiQuestion(
        id = 29,
        dimension = SbtiDimension.So3,
        question = "有时候你明明对一件事有不同的、负面的看法，但最后没说出来。多数情况下原因是：",
        options = listOf("这种情况下较少。", "可能碍于情面或者关系。", "不想让别人知道自己是个阴暗的人。"),
        weights = listOf(1, 2, 3)
    ),
    // Q30 - So3
    SbtiQuestion(
...
// 获取完整SBTI人格类型库
fun getPersonalityTypes(): List<PersonalityType> = listOf(
    PersonalityType(
        code = "CTRL",
        name = "拿捏者",
    ...
    PersonalityType(
        ...
        intro = "你以为我很有钱吗？",
        desc = "恭喜您，您竟然测出了这个世界上最稀有的妈妈人格。您或将成为金融界的未解之谜——是的，ATM-er不一定真的\"送钱\"，但可能永远在\"支付\"。支付时间、支付精力、支付耐心、支付一个本该安宁的夜晚。因此像一部老旧但坚固的ATM机，插进去的是别人的焦虑和麻烦，吐出来的是\"没事，有我\"的安心保证。您的人生就是一场盛大的、无人喝彩的单人付账秀。您竟用磐石般的可靠，承受了瀑布般的索取，偶尔夜深人静才会对着账单——可能是精神上的——发出一声叹息：我这该死的、无处安放的责任心啊。"
    ),
    PersonalityType(
        code = "Dior-s",
        name = "屌丝",
    ...
    PersonalityType(
        ...
        desc = "朋友，你不是\"童心未泯\"，你压根就没进化。你的灵魂还停留在那个挂在树上荡秋千、看见香蕉就两眼放光的快乐时代。当人类祖先决定从树上下来、学会直立行走、穿上西装打领带时，吗喽人格的祖先在旁边的大树上看着他们，挠了挠屁股，嘴里发出一声不屑的\"吱\"。他们看透了一切：所谓的\"文明\"，不过是一场最无聊、最好玩的付费游戏。规则偶尔是可以打破的，天花板是用来倒挂的，会议室是用来表演后空翻的。MALO本身就是一个从巨大脑洞里掉出来、忘了关门的奇思妙想。"
    ),
    PersonalityType(
        code = "JOKE-R",
        name = "小丑",
    ...
    PersonalityType(
        ...
        intro = "我，还活着吗？",
        desc = "恭喜您，您测出了全中国最为罕见的人格，只是\"死者\"这个名字实在有点晦气，所以也可以叫：Don't Expect Any Drives。死者已经看透了那些无意义的哲学思考，因此显得对一切\"失去\"了兴趣。死者们看世界的眼神，就像一位顶级玩家通关了所有主线、支线、隐藏任务，删档重开了999次之后，终于发现：这游戏压根就没意思。死者是超越了欲望和目标的终极贤者，他们的存zai，就是对这个喧嚣世界最沉默也最彻底的抗议。"
    ),
    PersonalityType(
        code = "IMFW",
        name = "废物",
